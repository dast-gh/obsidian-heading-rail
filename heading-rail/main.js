...
/* В закреплённом режиме динамика ширины отключена */
.hr-no-wave .hr-bar {
  width: var(--hr-base-w) !important;
}
...
.hr-cap-bar {
  ...
  opacity: 0.75;
  transition: width 130ms cubic-bezier(0.22, 1, 0.36, 1),
              background-color 130ms ease, opacity 130ms ease, height 130ms ease;
  will-change: width;
}
...
.hr-side {
  position: absolute;
  right: calc(var(--hr-rail-w, 56px) + 8px);
...
.hr-lvl-1 { padding-left: 8px;  font-weight: 600; color: var(--text-normal); }
